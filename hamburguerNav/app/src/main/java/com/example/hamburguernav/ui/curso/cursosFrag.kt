package com.example.hamburguernav.ui.curso
...
import com.example.hamburguernav.ui.gallery.cursosViewModel

class cursosFrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        val textView: TextView = binding.textCurso
        cursoViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        return root
    }
